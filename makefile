...
help:
	...
	-@echo "run-memoria-1-clockm"
	-@echo "run-memoria-1-lru"
	-@echo "$(GREEN) -------------- $(NOCOLOR)"
	-@echo "run-memoria-2-fija"
	-@echo "run-memoria-2-dinamica"
	-@echo "$(GREEN) -------------- $(NOCOLOR)"
	-@echo "run-memoria-3-fifo"
	-@echo "run-memoria-3-lru"
	-@echo "$(GREEN) -------------- $(NOCOLOR)"
	-@echo "$(GREEN) Pruebas SWAP $(NOCOLOR)"
	-@echo "run-swap-1"
	-@echo "$(GREEN) -------------- $(NOCOLOR)"
	-@echo "$(GREEN) Pruebas GENERALES $(NOCOLOR)"
	-@echo "run-general-1 (Saludo al humedal)"
	-@echo "run-general-2 (Batala por Nordelta)"
	-@echo "$(GREEN) -------------- $(NOCOLOR)"
