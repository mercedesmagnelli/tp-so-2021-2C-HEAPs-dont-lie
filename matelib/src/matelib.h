 ...
 * @RETURN: Retorna 0 si todos salió bien. No me queda claro en que caso puede fallar, tal vez al hacer init a una instancia que ya fue iniciada
 */
int mate_init(mate_instance *lib_ref, char *config);
/**
 * @NAME: mate_close
 * @DESC: Recibe una instancia y libera todos los recursos solicitados por la misma
 * @RETURN: Retorna 0 si todos salió bien. Puede que se trate de cerrar una instancia que no existe
 */
 ...
 * @RETURN: Retorna 0 si todos salió bien. Según entiendo solo puede hacer uso de esta función mientras este en estado EXEC
 */
 ...
 * @RETURN: Retorna 0 si todos salió bien. Según entiendo solo puede hacer uso de esta función mientras este en estado BLOCKED
 */
 ...
 * @RETURN: Retorna 0 si todos salió bien.
 */
 ...
 * @RETURN: Retorna 0 si todos salió bien. Puede que la dirección no exista o ya haya sido liberada
 */
 ...
 * @RETURN: Retorna 0 si todos salió bien. Puede que la dirección no exista
 */
